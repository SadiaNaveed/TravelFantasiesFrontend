      ...
      >
        ...
        >
          <Card style={{ width: "18rem", margin: "30px" }}>
            <img
              ...
              height="150px"
              alt="cover"
              style={{ borderRadius: "300px", marginLeft: "20%" }}
            />
            <Card body="true" style={{ marginLeft: "30px" }}>
              <Card title="true">
                {"Rimsha Tehreem"} style={{ marginLeft: "50px" }}{" "}
              </Card>
        ...
        >
          <Card style={{ width: "18rem", margin: "30px" }}>
            ...
            <Card body="true" style={{ marginLeft: "30px" }}>
              <Card title="true">
                {"Sadia Naveed"} style={{ marginLeft: "50px" }}{" "}
              </Card>
        ...
        >
          ...
          <Card style={{ width: "18rem", margin: "30px" }}>
            ...
            />
            <Card body="true" style={{ marginLeft: "30px" }}>
              <Card title="true" style={{ marginLeft: "50px" }}>
                {"Asma Bint e Umar"}
              </Card>
