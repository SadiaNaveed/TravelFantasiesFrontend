...
class SideBarComponent extends Component {
    ...
    _renderSubComp(){
        switch(this.state.render){
            case 'addHotel': return <HomeFragment/>
            case 'AllHotel': return <AllHomeFragmentHotel/>
            case 'Home': return <HomeFragment /> 
            case 'AllHotelCategory': return <HomeFragment />
            case 'AddHotelCategory' : return <HomeFragment />
