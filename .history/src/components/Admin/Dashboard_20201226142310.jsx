  ...
  return (
    <div>
      ...
      <div class="mb-4 col-12 col-md-6">
        <div class="card">
          <header class="card-header">Id indentifiers</header>
          <div class="card-body">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a href="#" class="active nav-link" data-tab="home">
                  Home
                </a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane active fade show" data-tab="home">
              ...
              <div class="tab-pane fade" data-tab="profile">
              ...
              <div class="tab-pane fade" data-tab="messages">
