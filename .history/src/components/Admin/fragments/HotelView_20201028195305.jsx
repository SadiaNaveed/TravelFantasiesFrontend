...
// console.log(this.props.history);
      ...
      {/* {home ? <HomeFragment /> : null}   */}
            ...
            <div style={{ marginLeft: "250px", marginTop: "120px" }}>
               <img src={this.state.Image} style={{ position:"absolute",marginLeft: "700px", height: "500px", width: "610px", backgroundColor: grey[50] }} alt="hotel" /> 
            <Button
              style={{
                backgroundColor: "white", border: "2px solid #4CAF50", borderRadius: "12px", color: "#4CAF50", fontSize: "24px", position: "absolute", marginTop: "550px", marginLeft: "1150px"
              }}
