            ...
            <div>
                ...
                >
                    ...
                    <div className={classes.drawerContainer}>
                        <List>
                            <ListItem button onClick={this.props.handleHomeClick} onClick={this.handleClick.bind(this, 'addHotel')}>
                            ...
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItem button className={classes.nested} onClick={this.props.handleOtherClick} onClick={this.handleClick.bind(this, 'addHotel')}>
                                        <ListItemIcon >
                                    ...
                                    <ListItem button className={classes.nested} onClick={this.props.handleOtherClick} onClick={this.handleClick.bind(this, 'AllHotel')}>
                                        <ListItemIcon>
