...
import { Grid, Button, Typography, Box, makeStyles, CssBaseline, List } from "@material-ui/core";
...
Back
                ...
                <Typography variant='h4' style={{marginLeft:"700px", color:"#339ba5" , fontStyle:"bold" }}>
                    ...
                    <Typography variant='h5' style={{marginLeft:"700px", color:"#339ba5" , fontStyle:"bold" }}>
                        <List>
                        {this.state.hotel.FreeWifi ? 'Free Wifi' : null}
                        {this.state.hotel.AirConditioning ? 'Air Conditioning' : null}
                        {this.state.hotel.BathTub ? 'Bath Tub' : null}
                        {this.state.hotel.HairDryer ? 'Hair Dryer' : null}
                        {this.state.hotel.InRoomIron ? 'In-Room Iron' : null}
                        {this.state.hotel.PremiumCoffee ? 'Premium Coffee' : null}
                        {this.state.hotel.RoomFridge ? 'Room Fridge' : null}
                        {this.state.hotel.RoomPurification ? 'Room Purification' : null}
                        {this.state.hotel.Shower ? 'Shower' : null}
                        {this.state.hotel.Television ? 'Television' : null}
                        {this.state.hotel.TeaMaker ? 'Tea Maker' : null}    
                      </List>
