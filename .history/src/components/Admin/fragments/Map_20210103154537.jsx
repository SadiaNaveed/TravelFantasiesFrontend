...
function GMap({ onMarker }) {
  ...
  return (
    ...
    >
      <Marker position={markers} draggable={true} onDragEnd={onMarker} />
    </GoogleMap>
  );
}
...
export default function Map({ onMarkerDrag }) {
  return (
    <div style={{ width: "78vw", height: "100vh" }}>
      <WrappedMap
