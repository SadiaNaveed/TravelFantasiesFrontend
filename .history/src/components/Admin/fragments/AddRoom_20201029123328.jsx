...
//         value: "xyz",
  ...
  handleCategoryNameChange(event) {
   ...
   handleClose () {
    ...
    handleChange = (event) => {
        this.setState({ ...this.state.state, [event.target.name]: !event.target.name.value });
        this.setState({ this.state.state.checkedA: !this.state.state.checkedA});
    ...
    return (
      ...
      {/* <FormControlLabel
        ...
        label="Custom size"
                /> */}
                <FormControlLabel
        control={<GreenCheckbox checked={this.state.state.checkedA} onChange={this.handleChange} name="checkedA" />}
        label="Custom color"
      />
                  <FormControlLabel
        control={
