  ...
  handleSubmit(event) {
    ...
    return (
      <div style={{ marginTop: "100px", marginLeft:"300px", marginBottom:"100px"}}>
        ...
        >
          ...
          <button variant="contained" style={{color: "blue" , position:"absolute", left:"50%" , justifyContent: "center" , alignItems: "center"}}>
            ...
            <FormGroup row>
      <FormControlLabel
        control={<Checkbox checked={this.state.state.checkedA} onChange={this.handleChange} name="checkedA" />}
        label="Secondary"
      />
      <FormControlLabel
        control={
      ...
      <FormControlLabel
        control={
          <Checkbox
            checked={this.state.state.checkedF}
            onChange={this.handleChange}
            name="checkedF"
            indeterminate
          />
      ...
      />
      <FormControlLabel
        control={<GreenCheckbox checked={this.state.state.checkedG} onChange={this.handleChange} name="checkedG" />}
        label="Custom color"
      />
      <FormControlLabel
