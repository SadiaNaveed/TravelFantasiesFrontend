...
// console.log(this.props.history);
      ...
      {/* {home ? <HomeFragment /> : null}   */}
            ...
            <div style={{ marginLeft: "50px", marginTop: "120px", marginBottom:"50px" }}>
               <img src={this.state.Image} style={{ position:"absolute",marginLeft: "10px", height: "300px", width: "410px", backgroundColor: grey[50] }} alt="hotel" /> 
            <Button
              style={{
...
Back
                    ...
                    <Typography variant='h4' style={{marginLeft:"1500px", color:"#339ba5" , fontStyle:"bold"}}>
                    {this.state.hotel.Descriptiom}
                </Typography>
                <Typography variant='h5' style={{marginLeft:"1500px"}}>
                    {this.state.hotel.NumberOfRooms}
                </Typography>
                <Typography variant='h6' style={{marginLeft:"150px"}}>
                    Ratings {this.state.hotel.Cost}
                </Typography>
                
                <h2 style={{marginTop:"100px", color:"#339ba5"}}>Facilities of Room</h2>
