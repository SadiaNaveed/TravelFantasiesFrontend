...
// console.log(this.props.history);
      ...
      {/* {home ? <HomeFragment /> : null}   */}
            ...
            >
                ...
                <Button style={{ backgroundColor: "white" , fontSize:"24px", border: "2px solid #008CBA", borderRadius:"12px", color:"#008CBA", position:"absolute", marginTop:"550px",marginLeft:"1020px"}}>
                    View on Map
                </Button>
