  ...
  render() {
    return (
      <div style={{ marginTop: "100px", marginLeft: "200px" }}>
        ...
        <div class="row"><div class="col-12 col-sm-6"><div class="card"><header class="card-header">Form<small> validation feedback</small></header><div class="card-body"><div class="form-group"><label class="" for="inputIsValid">Input is valid</label><input class="form-control is-valid" type="text" id="inputIsValid"><div class="valid-feedback">Cool! Input is valid</div></div><div class="form-group"><label class="" for="inputIsInvalid">Input is invalid</label><input class="form-control is-invalid" type="text" id="inputIsInvalid"><div class="invalid-feedback">Houston, we have a problem...</div></div></div></div></div><div class="col-12 col-sm-6"><div class="card"><header class="card-header">Validation feedback Form</header><div class="card-body"><form class="was-validated"><div class="form-group"><label class="" for="inputSuccess2i">Non-required input</label><input class="form-control form-control-success" type="text" id="inputSuccess2i"><div class="valid-feedback">Non-required</div></div><div class="form-group"><label class="" for="inputWarning2i">Required input</label><input class="form-control form-control-warning" type="text" id="inputWarning2i" required=""><div class="invalid-feedback help-block">Please provide a valid information</div><div class="valid-feedback help-block">Input provided</div></div></form></div></div></div></div>
      </div>
    );
  }
}
