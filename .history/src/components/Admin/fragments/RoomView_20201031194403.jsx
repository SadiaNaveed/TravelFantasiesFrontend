...
Back
          ...
          <ListItemText primary={this.state.hotel.FreeWifi && 'Free Wifi' } />
        </ListItem>
                     <ListItem>
          
          <ListItemText primary={this.state.hotel.AirConditioning &&'Air Conditioning'} />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.BathTub && 'Bath Tub' } />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.HairDryer && 'Hair Dryer' } />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.InRoomIron && 'In-Room Iron' } />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.PremiumCoffee && 'Premium Coffee'}/>
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.RoomFridge && 'Room Fridge' } />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.RoomPurification && 'Room Purification'} />
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.Shower && 'Shower' }/>
                            </ListItem>
          <ListItem>
          
          <ListItemText primary={this.state.hotel.Television && 'Television'} />
                            </ListItem>
                            <ListItem>
          
          <ListItemText primary= {this.state.hotel.TeaMaker && 'Tea Maker'}    />
                            </ListItem>
