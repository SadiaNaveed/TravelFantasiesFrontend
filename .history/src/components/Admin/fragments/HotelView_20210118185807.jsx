              ...
              <table class="table table-striped table-hover">
                ...
                <tbody style={{ cursor: "pointer" }}>
                  <tr class="" tabIndex="0">
                    ...
                    <td class="">{this.state.hotel.Location}</td>
                    <td class="">{this.state.hotel.Cost}</td>
                    <td class="">{this.state.hotel.Contactno}</td>
                    <td>
                      <Button
                        onClick={() =>
                          this.onAllRoomsClick(this.state.hotel._id)
                        }
                      >
                        View Rooms{" "}
                      </Button>
                      <Button
                        onClick={() =>
                          this.onAddRoomClick(this.state.hotel._id)
                        }
                      >
                        Add Room{" "}
                      </Button>
                    ...
                    <td>
                      <Button
                        onClick={() =>
                          this.onViewButtonClick(this.state.hotel._id)
                        }
                      >
                        <Visibility />
                      </Button>
                      ...
                      <Button
                        onClick={() =>
                          this.onDeleteButtonClick(this.state.hotel._id)
                        }
                      >
                        <Delete />{" "}
                      </Button>
