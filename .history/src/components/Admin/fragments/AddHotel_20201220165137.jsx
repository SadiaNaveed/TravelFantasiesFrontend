    ...
    return (
      <div style={{ marginTop: "100px", marginLeft: "200px" }}>
        ...
        <div class="col-12 col-sm-6">
          <div class="card">
            <header class="card-header">Form<small> validation feedback</small></header>
            <div class="card-body">
              <div class="form-group">
                <label class="" for="inputIsValid">Input is valid</label>
                <input class="form-control is-valid" type="text" id="inputIsValid"> </input>
                  <div class="valid-feedback">Cool! Input is valid</div>
                  </div>
                <div class="form-group">
                  <label class="" for="inputIsInvalid">Input is invalid</label>
                  <input class="form-control is-invalid" type="text" id="inputIsInvalid"> </input>
                    <div class="invalid-feedback">Houston, we have a problem...</div>
                    </div>
                </div>
              </div>
            </div>
