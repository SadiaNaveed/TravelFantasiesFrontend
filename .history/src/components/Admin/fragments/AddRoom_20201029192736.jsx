...
//         value: "xyz",
  ...
  handleSubmit(event) {
    ...
    const formData = new FormData();
     formData.append("Category", this.state.SelectedCategory._id);
    ...
    // this.setState({ value: event.target.value });
        ...
        // this.setState({ CategoryId: event.target.key });
             roomCategoryService
        .getSpecificRoomCategory(this.state.SelectedCategory)
        .then((data) => {
          this.setState({ responseCategory: data });
            console.log(this.state.responseCategory);
          // setTotal(data.total);
          // setPerPage(10);
        })
        .catch((err) => {
