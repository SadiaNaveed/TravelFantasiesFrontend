                ...
                >
                    ...
                    <div className={classes.drawerContainer}>
                        <List>
                            ...
                            <ListItem button onClick={this.handleOtherClick} onClick={this.handleHotelClick} >
                            ...
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItem button className={classes.nested} onClick={this.handleOtherClick} onClick={this.handleClick.bind(this, 'addHotel')}>
                                        <ListItemIcon >
                                            <Add className={classes.icon} />
                                        </ListItemIcon>
                                        <ListItemText primary="Add new Hotel" />
                                    </ListItem>
                                    <ListItem button className={classes.nested} onClick={this.handleOtherClick} onClick={this.handleClick.bind(this, 'AllHotel')}>
                                        <ListItemIcon>
