          ...
          <TableRow>
            ...
            <StyledTableRow key={hotel._id}>
              ...
              <StyledTableCell align="center">{hotel.Cost}</StyledTableCell>
                            <StyledTableCell align="center">{hotel.Contactno}</StyledTableCell>h
                            <StyledTableCell align="center"><Button>Update Details</Button> <Button>Remove </Button> </StyledTableCell>  
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
