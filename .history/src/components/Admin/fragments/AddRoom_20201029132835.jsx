...
//         value: "xyz",
  ...
  handleCategoryNameChange(event) {
   ...
   handleClose () {
    ...
    handleChange(event) {
       this.setState({ ...this.state.state, [this.state.state[event.target.name]]: event.target.checked });
        console.log(event.target.name);
        console.log(event.target.checked);
        console.log(this.state.state[event.target.name].value);

        // let checked = [...this.state.state];
        // let check = { ...this.state.state[event.target.name] } ;
        // check = event.target.checked;
        // checked[event.target.name] = check;
       ...
       // this.setState({ ...this.state.checked, [event.target.name]: event.target.name });
        ...
        console.log(this.state.state);
                console.log(this.state.state.checkedA);
        console.log(this.state.state.checkedB);
        console.log(this.state.state.checkedC);
                console.log(this.state.state.checkedD);
  };
