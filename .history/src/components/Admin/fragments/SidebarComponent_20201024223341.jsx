...
class SideBarComponent extends Component {
    ...
    switch (name) {
      case "showHome":
        ...
        break;
      case "showOther":
        this.setState({ other: !this.state.home });
        break;
      default:
        null;
    }
            ...
            <div>
                ...
                >
                    ...
                    <div className={classes.drawerContainer}>
                        <List>
                            <ListItem button onClick={() => this.hideComponent("showHome")} onClick={this.handleClick.bind(this, 'Home')}>
                            ...
                            <ListItem button onClick={() => this.hideComponent("showOther")}  onClick={this.handleHotelClick} >
                            ...
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItem button className={classes.nested} onClick={() => this.hideComponent("showOther")}  onClick={this.handleClick.bind(this, 'addHotel')}>
                                        <ListItemIcon >
                                            <Add className={classes.icon} />
                                        </ListItemIcon>
                                        <ListItemText primary="Add new Hotel" />
                                    </ListItem>
                                    <ListItem button className={classes.nested} onClick={() => this.hideComponent("showOther")}  onClick={this.handleClick.bind(this, 'AllHotel')}>
                                        <ListItemIcon>
