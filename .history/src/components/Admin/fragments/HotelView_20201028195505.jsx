...
// console.log(this.props.history);
      ...
      {/* {home ? <HomeFragment /> : null}   */}
            <SidebarComponent />
            <div style={{ marginLeft: "270px", marginTop: "120px" }}>
               <img src={this.state.Image} style={{ position:"absolute",marginLeft: "800px", height: "500px", width: "610px", backgroundColor: grey[50] }} alt="hotel" /> 
            <Button
              style={{
                backgroundColor: "white", border: "2px solid #4CAF50", borderRadius: "12px", color: "#4CAF50", fontSize: "24px", position: "absolute", marginTop: "550px", marginLeft: "900px"
              }}
              onClick={() => this.onAddRoomClick(this.state.hotel._id)}
            >
                    Add Room
                 </Button>     
                <Button style={{ backgroundColor: "white" , fontSize:"24px", border: "2px solid #008CBA", borderRadius:"12px", color:"#008CBA", position:"absolute", marginTop:"550px",marginLeft:"1120px"}}>
                    View on Map
                </Button>
                ...
                <h2 style={{marginTop:"100px", color:"#339ba5"}}>Facilities of {this.state.hotel.HotelName}</h2>
                <Typography variant='h6' style={{marginRight:"800px"}}>
                     {this.state.hotel.Facilities}
                </Typography>
