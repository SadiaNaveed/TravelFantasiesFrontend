...
class SideBarComponent extends Component {
    ...
    render() {
        ...
        return (
            <div>
                 {this.props.home ? <HomeFragment /> : null} 
                <Drawer
                ...
                >
                    ...
                    <div className={classes.drawerContainer}>
                        <List>
                            <ListItem button onClick={this.props.handleHomeClick} onClick={this.handleClick.bind(this, 'Home')}>
                            ...
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItem button className={classes.nested} onClick={() => this.showHomeComponent("showOther")}  onClick={this.handleClick.bind(this, 'addHotel')}>
                                        <ListItemIcon >
                                    ...
                                    <ListItem button className={classes.nested} onClick={() => this.showHomeComponent("showOther")}  onClick={this.handleClick.bind(this, 'AllHotel')}>
                                        <ListItemIcon>
