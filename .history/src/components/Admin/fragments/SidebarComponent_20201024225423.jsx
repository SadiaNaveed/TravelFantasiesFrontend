             ...
             {home && <HomeFragment />}                
                ...
                >
                    ...
                    <div className={classes.drawerContainer}>
                        <List>
                            {/* onClick={() => this.hideComponent("showHome")} */}
                            ...
                            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItem button className={classes.nested} onClick={this.handleClick('addHotel')}>
                                        <ListItemIcon >
                                            <Add className={classes.icon} />
                                        </ListItemIcon>
                                        <ListItemText primary="Add new Hotel" />
                                    </ListItem>
                                    <ListItem button className={classes.nested} onClick={this.handleClick('AllHotel')}>
                                        <ListItemIcon>
