...
class AllHotel extends Component {
  ...
  onViewButtonClick = (props,id) => {
    // let history = useHistory();
    this.props.history.location.search.push({
       
       search: '?hotel=' + id,
       
    })
     this.props.history.location.pathname.push({
            ...
            <StyledTableRow key={hotel._id}>
              ...
              <StyledTableCell align="center">{hotel.Cost}</StyledTableCell>
                            ...
                            <StyledTableCell align="center">
                              ...
                              <Button   onClick={() => this.onViewButtonClick(this.props, hotel._id)} ><Visibility /></Button>
                              <Button><Edit /> </Button>
