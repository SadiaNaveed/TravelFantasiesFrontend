...
class Hotels extends Component {
  ...
  onSearchChange = (e) => {
    ...
    //       hotel.HotelName.toLowerCase().includes(search.toLocaleLowerCase())
    //     );
    // console.log(res);
  ...
  search = async (val) => {
    ...
    const res = await axios(`http://localhost:4000/api/hotels?query=${val}`);
  ...
  get renderMovies() {
    ...
    if (this.state.hotel) {
      hotel = <Hotels list={this.state.hotel} />;
    }
  ...
  render() {
    ...
    //   ? hotels
    //   : hotels.filter((hotel) =>
    //       hotel.HotelName.toLowerCase().includes(searchTerm.toLocaleLowerCase())
    //     );
    console.log(this.state.results);
    ...
    return (
      ...
      >
        ...
        {/* <SearchBox
          ...
          // }}
          onSearchClicked={this.onSearchChange}
        /> */}
        <input
          type="search"
          className="search"
