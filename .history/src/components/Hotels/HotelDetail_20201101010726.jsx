...
console.log(this.props.history);
      ...
      <AppBarComponenet />
            ...
            <Button style={{ backgroundColor: "white", border: "2px solid #4CAF50", borderRadius: "12px", color: "#4CAF50", fontSize: "24px", position: "absolute", marginTop: "550px", marginLeft: "1000px" }}
