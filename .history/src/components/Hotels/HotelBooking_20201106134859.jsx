...
class HotelBooking extends Component{
  ...
  handleSubmit = (e) => {
    ...
    if (this.handleValidation()) {
      ...
      if (this.state.errors.guest !== "undefined" && this.state.errors.rooms !== "undefined") {
        //alert(this.state.errors.guests + "and" + this.state.errors.rooms);
        alert("Please select the number of guests and number of rooms");
        console.log(this.state.errors);
      }
      else if (this.state.errors.guest !== "undefiened") {
