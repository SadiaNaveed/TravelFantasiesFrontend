...
class HotelBooking extends Component {
  ...
  onPaymentButtonClick = (event) => {
    ...
    if (this.handleValidation()) {
      ...
      if (
        ...
        this.state.Departure_Time == null &&
        this.state.Arrival_Time == null
      ) {
        ...
        //   alert(this.state.errors.guests);
        toast.error("Please select the check-out time", {
          position: toast.POSITION.TOP_LEFT,
        });
        //console.log(this.state.errors.guests);
        ...
        //console.log(this.state.errors.guests);
      } else if (this.state.Arrival_Time == null) {
        //   alert(this.state.errors.guests);
        toast.error("Please select the check-out time", {
          position: toast.POSITION.TOP_LEFT,
        });
  ...
  handleValidation() {
    ...
    let startTime = this.state.Arrival_Time;
    let endTime = this.state.Departure_Time;
