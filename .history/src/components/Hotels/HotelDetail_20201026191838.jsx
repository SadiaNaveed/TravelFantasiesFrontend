...
console.log(this.props.history);
        ...
        return (
            ...
            <div style={{ marginTop: "200px", marginBottom: "100px" }}> 
                    ...
                    <img src={this.state.Image} style={{ position:"absolute",marginLeft: "1000px", height: "900px", width: "610px", backgroundColor: grey[50] }} alt="hotel" /> 
                 
                    <Typography variant='h4' style={{position:"absolute",marginLeft:"20px"}}>
