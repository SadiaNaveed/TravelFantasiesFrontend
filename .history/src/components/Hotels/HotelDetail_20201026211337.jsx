...
console.log(this.props.history);
        ...
        return (
            <div style={{ marginTop: "160px", marginBottom: "200px" }}> 
                ...
                <Button style={{  backgroundColor: "#4CAF50", position:"absolute", marginTop:"600px",marginLeft:"1000px" }}>
                    Book Now
                 </Button>     
                <Button style={{ backgroundColor: "#008CBA" , position:"absolute", marginTop:"600px",marginLeft:"1100px"}}>
                    View on Map
                </Button>
