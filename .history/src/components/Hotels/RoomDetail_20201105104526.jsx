...
import { Grid, Button, Typography, Box, makeStyles, CssBaseline, List, ListItem, ListItemText, ListItemIcon } from "@material-ui/core";
   ...
   roomService
    ...
    onBookingButtonClick = () => {
        ...
        this.props.history.push({
            ...
            search: '?Category=' + categorySearch + '&room=' + roomSearch + '&hotel=' + { this.state.room.HotelId },
...
// console.log(this.props.history);
      ...
      {/* {home ? <HomeFragment /> : null}   */}
            ...
            <div style={{ marginLeft: "50px", marginTop: "120px", marginBottom:"50px" }}>
             ...
             <Button
              style={{
                backgroundColor: "white", border: "2px solid #4CAF50", borderRadius: "12px", color: "#4CAF50", fontSize: "24px", position: "absolute", marginTop: "310px", marginLeft: "70px"
              }}
            ...
            >
                    ...
                    <Button
              style={{
                backgroundColor: "white", border: "2px solid #4CAF50", borderRadius: "12px", color: "#4CAF50", fontSize: "24px", position: "absolute", marginTop: "310px", marginLeft: "230px"
              }}
...
Back
          ...
          <ListItem>
           ...
           {this.state.hotel.BathTub && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Bath Tub" />
                                </ListItem> }
                            {this.state.hotel.HairDryer && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Hair Dryer" />
                                </ListItem> } 
     {this.state.hotel.InRoomIron && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="In-Room Iron" />
                                </ListItem>} 
                          {this.state.hotel.PremiumCoffee && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                           ...
                           {this.state.hotel.RoomFridge && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Room Fridge" />
                        </ListItem> }
                     {this.state.hotel.RoomPurification && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Room Purification" />
                        </ListItem>}       
                           {this.state.hotel.Shower && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Shower" />
                        </ListItem> }
                        {this.state.hotel.Television && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
                                    <ListItemText primary="Television" />
                        </ListItem>}
                        {this.state.hotel.TeaMaker && <ListItem>
                                    <ListItemIcon>
                                        <StarBorder />
                                    </ListItemIcon>
