  ...
  // const { hotel, history } = props;
    ...
    return window.btoa(binary);
     ...
     this.props.history.push({
       ...
       search: '?hotel=' + this.state.hotel._id,
...
console.log(this.props.history);
      ...
      <AppBarComponenet />
          ...
          Book Now 
                ...
                <h2 style={{marginTop:"190px", color:"#339ba5"}}>Rooms of {this.state.hotel.HotelName}</h2>

              {this.state.rooms.map((room, index) => (
                 room.Image = 'data:image/jpeg;base64,' + this.arrayBufferToBase64(room.Image.data.data),
                // console.log(hotel.Image),
               // <img src={hotel.Image} style={{height:"30px",width: "30px"}} alt='Helpful alt text'/>

                 <SingleHotel key={index} room={room} />
              ))}
