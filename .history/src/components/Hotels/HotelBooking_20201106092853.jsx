...
class HotelBooking extends Component{
 ...
 calculateDaysLeft(startDate, endDate) {
  ...
  //  const { hotel, history } = props;
        const daysLeft = this.calculateDaysLeft(this.state.tartDate, this.state.endDate);
...
<DatePicker
      ...
      inline
                  ...
                  {/* <DatePicker selected={this.statestartDate} onChange={date => this.setState({ startDate: date }), console.log(this.state.startDate.getDate())} /> */}
                    {/* <DateTimePicker
