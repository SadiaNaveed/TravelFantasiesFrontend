...
console.log(this.props.history);
        ...
        return (
            <div style={{ marginTop: "160px", marginBottom: "200px" }}> 
                ...
                <Button style={{  backgroundColor: "#white", borderColor: "#4CAF50", borderRadius:"12px", color:"#4CAF50", fontSize:"24px", position:"absolute", marginTop:"550px",marginLeft:"1150px" }}>
                    Book Now
                 </Button>     
                <Button style={{ backgroundColor: "#008CBA" , fontSize:"24px", position:"absolute", marginTop:"550px",marginLeft:"1320px"}}>
                    View on Map
                </Button>
