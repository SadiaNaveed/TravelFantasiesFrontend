...
class Hotels extends Component {
  ...
  handleCommentEdit(event) {
    var data = this.state.floors;
    var commentIndex = data.findIndex(function (c) {
      return c.Name == [event.target.name];
    });
    if (commentIndex == -1 ? this.setState(floors: { Name: [event.target.name], Checked: event.target.checked }
       )
              ...
              (hotel, index) => (
                ...
                (
                  ...
                  <SingleHotel
                    ...
                    // });
                    // console.log(floors);
                    // unique = floors.filter((v, i, a) => a.indexOf(v) === i);
                    //unique = [...new Set(floors)]; // [1, 2, 3, 5, 8, 9, 4]
                    //   console.log(floors);
