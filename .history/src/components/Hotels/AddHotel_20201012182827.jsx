...
class addHotel extends Component {
  ...
  handleSubmit(event) {
    ...
    // formData.append("ImageData", this.state.Image, this.state.Image.name);
    //formData.append("Image", this.state.Image);
    // const config = {
    //   headers: {
    ...
    //console.log(data);
    const data={"HotelName":" knk","Location":"nn","ImageData":"kkkkkkkj","Address":"jnj","Contactno":"jnjn","CheckIn":"jnj","CheckOut":"njn","Website":"njnj","Facilities":"njn ","Availablity":"jn","Ratings":"jnjn","ImageName":"card.jpeg"};
    console.log(formData);
    hotelService
      .addHotel(data)
      .then((response) => {
