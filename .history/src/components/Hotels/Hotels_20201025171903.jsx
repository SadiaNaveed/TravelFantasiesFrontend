  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div>
          <h1 style={{ position: "absolute", left: "300px", top: "300px", color: "white", fontSize: 70 }}>Welcome To The Hotels of Pakistan! </h1>
          <h1 style={{position:"absolute",left:"400px", top:"400px",color:"white",fontSize:70}}>Find your Best Hotel Here! </h1>
