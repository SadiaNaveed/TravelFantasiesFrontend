...
function GMap({ lati, lngi }) {
  ...
  return (
    <GoogleMap defaultZoom={8} defaultCenter={{ lat: lati, lng: lngi }}>
...
export default function MapView(props) {
  const hotelId = queryString.parse(props.history.location.search);
  const hotelID = hotelId.hotel;
  const latitude = hotelId.lat;
  const longitude = hotelId.lng;
  console.log(hotelId);
  return (
