...
<div class="row">
                    <div class="col-md-12">
                        <span class="heading">Filters <i class="fas fa-sliders-h CatFilter"></i></span>
                        <span id="div_sort" class="float-right mr-4 searchSort">Sort By
                          <select id="cata_sort">
                            <!-- <option name="cata_sort" data-filter-key="sort" data-filter-value="" selected="selected" value="">Select sort</option> -->
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="most_relavant" selected="selected" value="most_relavant">Most Relavant</option>
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="latest" value="latest">Latest</option>
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="popular" value="popular">Popularity</option>
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="highest_rated" value="highest_rated">Highest Rated</option>
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="high-to-low" value="high-to-low">Price: High to Low</option>
                            <option name="cata_sort" data-filter-key="sort" data-filter-value="low-to-high" value="low-to-high">Price: Low to High</option>
                          </select>
                        </span>
                        <hr>
                    </div>
