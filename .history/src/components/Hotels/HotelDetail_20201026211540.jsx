...
console.log(this.props.history);
        ...
        return (
            <div style={{ marginTop: "160px", marginBottom: "200px" }}> 
                ...
                <Button style={{  backgroundColor: "#4CAF50", fontSize:"24px", position:"absolute", marginTop:"600px",marginLeft:"1200px" }}>
                    Book Now
                 </Button>     
                <Button style={{ backgroundColor: "#008CBA" , fontSize:"24px", position:"absolute", marginTop:"600px",marginLeft:"1300px"}}>
                    View on Map
                </Button>
