        ...
        <div class="row position-relative" id="divCatLogLeft">
          ...
          <div class="col-xl-10 serach_pgn">
            <ul
              ...
              style={{margin-top: 20px; padding-left: 27px;list-style-type: none;"
            >
              <li>
                {" "}
                <div class="searchResultSection row">
                  <div class="searchLeftImg col-4 col-sm-3">
                    <a
                      style={{color: #293F4F;"
                      href="https://www.eduonix.com/nodejs-skill-bundle"
                    >
                      <amp-img
                        src="https://cdn.eduonix.com/assets/images/bundle_images/feature_img/nodejs-skill-bundle.jpg"
                        alt="Banner"
                        height="80"
                        width="125"
                        layout="responsive"
                        style={{border-radius: 6px; --loader-delay-offset:600ms !important;"
                  ...
                  <div class="searchResultMiddle col-8 col-sm-9">
                    ...
                    <div class="Description">
                      Become a Skilled NodeJS Developer with this Online Bundle{" "}
                    </div>
                    ...
                    <div id="114" class="clearfix">
                      <span class="rateWrap">
                        ...
                        <span class="rateInfo">3.99</span>
                      </span>

                      <span class="price">
                        {" "}
                        <strike class="mr-1">$160</strike>
                        <span class="originalPrice">$40</span>
                      </span>
                      <span
                        class="collectionCartWish wishcartthmbcomm_114 pt-0"
                        style={{display: inline-flex;"
                      >
                        <span class="addcart_div" style={{width: 26px;">
                          <strong>
                            <a onclick="addtocart(this, '114', '', 'deals', 'searchedcourses');">
                              <i
                        ...
                        <span class="wishlistIcon" style={{margin-left: 10px;">
                          <i
                            onclick='set_addtowish_para("114","deals"); showPopUp("addtowish","loginPopUp","signUpPopUp");'
                            class="far fa-heart"
                          ></i>
                        </span>
                      </span>
              ...
              <li>
                ...
                <div class="searchResultSection row">
                  <div class="searchLeftImg col-4 col-sm-3">
                    <a
                      style={{color: #293F4F;"
                      href="https://www.eduonix.com/the-unity-3d-coding-bundle"
                    >
                      <amp-img
                        src="https://cdn.eduonix.com/assets/images/bundle_images/feature_img/20171208180551.jpg"
                        alt="Banner"
                        height="80"
                        width="125"
                        layout="responsive"
                  ...
                  <div class="searchResultMiddle col-8 col-sm-9">
                    ...
                    <div class="Description">
                      Get the Best Deal on Unity 3D Course at Discounted Prices{" "}
                    </div>
                    ...
                    <div id="29" class="clearfix">
                      <span class="rateWrap">
                        ...
                        <span class="rateInfo">4.63</span>
                      </span>

                      <span class="price">
                        {" "}
                        <strike class="mr-1">$64</strike>
                        <span class="originalPrice">$16</span>
                      </span>
                      <span
                        class="collectionCartWish wishcartthmbcomm_29 pt-0"
                        style={{display: inline-flex;"
                      >
                        <span class="addcart_div" style={{width: 26px;">
                          <strong>
                            <a onclick="addtocart(this, '29', '', 'deals', 'searchedcourses');">
                              <i
                                class="fas fa-shopping-cart"
                                style={{color: #ccc;"
                              ></i>
                        ...
                        <span class="wishlistIcon" style={{margin-left: 10px;">
                          <i
                            onclick='set_addtowish_para("29","deals"); showPopUp("addtowish","loginPopUp","signUpPopUp");'
                            class="far fa-heart"
                          ></i>
                        </span>
                      </span>
                  ...
                  <div class="searchResultMiddle col-8 col-sm-9">
                    ...
                    <div id="10550" class="clearfix">
                      ...
                      >
                        ...
                        <span class="wishlistIcon" style={{ marginLeft: "10px" }}>
                          <i
                ...
                <div class="searchResultSection row">
                  ...
                  <div class="searchResultMiddle col-8 col-sm-9">
                    <div class="searchResultProjectName">
                      ...
                      <span
                        class="spnThumbFtured"
                        style={{backgroundColor: "#f98638",position: "relative" ,right: "0",top: "0px"}}
                      >
                        Highest Rated
                      </span>{" "}
                    </div>
