...
console.log(this.props.history);
        ...
        return (
            ...
            <Box p="10px" bgcolor="#F0FFF0" height="500px" mx="30px" borderRadius="6px" margin="10px" marginBottom="70px" border="1px solid" borderColor="#C0C0C0">
                    <img src={'data:image/jpeg;base64,' + this.arrayBufferToBase64(this.state.hotel.Image.data)} style={{ marginLeft: "10px", height: "300px", width: "310px", backgroundColor: grey[50] }} alt="hotel" /> 
