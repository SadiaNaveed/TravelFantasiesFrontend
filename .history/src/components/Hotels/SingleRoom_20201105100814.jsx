 ...
 class SingleRoom extends Component {
   ...
   onViewButtonClick = () => {
      this.props.history.push({
        pathname: '/roomDetail',
        search:'&room=' + this.props.room._id +'&Category=' + this.props.room.Category,
    ...
    return (
      <Box p="10px" bgcolor="#F0FFF0" height="180px" mx="30px" borderRadius="6px" margin="10px" marginBottom="70px" border="1px solid" borderColor="#C0C0C0">
       ...
       <img src={this.props.room.Image} style={{position:"absolute", marginLeft: "10px", height: "150px", width: "210px", backgroundColor: grey[50] }} alt="room" />
        ...
        <Typography variant='h5' style={{position:"absolute", marginLeft:"230px", marginTop:"50px"}}>
          {this.props.room.Description}
        </Typography>

        <Typography variant='h5' style={{position:"absolute", marginLeft:"1100px"}}>
        ...
        <Button style={{ backgroundColor: "#008CBA", position: "absolute", marginLeft: "1100px", marginTop: "60px" }}
         onClick={this.onViewButtonClick}>
          View Details
      </Button>
        <Button
          style={{ backgroundColor: "#008CBA", position: "absolute", marginLeft: "1230px", marginTop: "60px" }}
        >
          Book Now
      </Button>
      </Box>
