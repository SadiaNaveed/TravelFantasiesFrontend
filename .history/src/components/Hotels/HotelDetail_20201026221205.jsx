...
console.log(this.props.history);
        ...
        return (
            <div style={{ marginTop: "160px", marginBottom: "200px", marginLeft:"50px"}}> 
        ...
        <Comment.Text>
          ...
          documentation.
                ...
                <h2>Related Hotesls</h2>
                    <img src={this.state.Image} style={{ position:"absolute",marginLeft: "180px", height: "250px", width: "300px", backgroundColor: grey[50] }} alt="hotel" /> 
                    <img src={this.state.Image} style={{ position:"absolute",marginLeft: "300px", height: "250px", width: "300px", backgroundColor: grey[50] }} alt="hotel" /> 
                    <img src={this.state.Image} style={{ position:"absolute",marginLeft: "6000px", height: "250px", width: "300px", backgroundColor: grey[50] }} alt="hotel" /> 
                    <img src={this.state.Image} style={{ position:"absolute",marginLeft: "1000px", height: "250px", width: "300px", backgroundColor: grey[50] }} alt="hotel" /> 
