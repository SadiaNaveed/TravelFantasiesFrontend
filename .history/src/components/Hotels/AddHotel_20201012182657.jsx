...
class addHotel extends Component {
  ...
  handleSubmit(event) {
    ...
    //console.log(data);
    const data={"HotelName":" knk","Location":"nn","ImageData":{},"Address":"jnj","Contactno":"jnjn","CheckIn":"jnj","CheckOut":"njn","Website":"njnj","Facilities":"njn ","Availablity":"jn","Ratings":"jnjn","ImageName":"card.jpeg"};
    console.log(formData);
    hotelService
      .addHotel(data)
      .then((response) => {
