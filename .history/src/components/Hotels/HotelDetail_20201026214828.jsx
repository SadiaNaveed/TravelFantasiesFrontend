        ...
        return (
            <div style={{ marginTop: "160px", marginBottom: "200px", marginLeft:"50px"}}> 
                ...
                <Button style={{ backgroundColor: "white" , fontSize:"24px", border: "2px solid #008CBA", borderRadius:"12px", color:"#008CBA", position:"absolute", marginTop:"550px",marginLeft:"1320px"}}>
                    ...
                    <Typography variant='h4' style={{marginLeft:"20px", color:"#339ba5"}}>
                ...
                <h2 style={{marginTop:"150px", color:"#339ba5"}}>Facilities of {this.state.hotel.HotelName}</h2>
                <Typography variant='h6' style={{marginRight:"800px"}}>
                     {this.state.hotel.Facilities}
                </Typography>
                
                <h1 style={{color:"#339ba5"}}> Rate {this.state.hotel.HotelName} </h1>
                <ReactStars
    count={5}
