...
const rows = [
  createData('Hotel 1', 159, 6.0, 24),
  createData('Hotel 2', 237, 9.0, 37),
  createData('Hotel 3', 262, 16.0, 24),
  createData('Hotel 3', <button>Book Now</button>, <button>Book Now</button>, <button>Book Now</button>),
