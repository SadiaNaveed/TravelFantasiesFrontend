...
import userImage from "../../Asserts/userImage.jpg";
            ...
            {this.state.Comments.map((comment, index) => (
              ...
              >
                <div>
                  ...
                  />
                  {/* )} */}
                  <h4 style={{ color: "#339ba5" }}>
                    {
                      <script>
                        var randomName = faker.name.findName(); // Caitlyn
                        Kerluke var randomEmail = faker.internet.email(); //
                        Rusty@arne.info var randomCard =
                        faker.helpers.createCard(); // random contact card
