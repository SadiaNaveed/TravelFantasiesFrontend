...
class Place extends Component {
  ...
  render() {
    ...
    return (
        <div>
          <h1 style={{ position: "absolute", left: "300px", top: "350px", color: "white", fontSize: 70 }}>Places to Visit in Pakistan! </h1>
          <h1 style={{position:"absolute",left:"420px", top:"420px",color:"white",fontSize:70}}>Find visiting places here! </h1>

          <img src={cover} style={{width:"100%", height:"700px"}}/>
      
        {this.state.Place_Detail.length == 0 ? (
          <p>There are no places</p>
        ) : (
            <Grid container spacing={3}>
             
              {this.state.Place_Detail.map((place, index) => (
