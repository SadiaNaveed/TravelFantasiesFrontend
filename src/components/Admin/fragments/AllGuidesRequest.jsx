...
class AllGuidesRequest extends Component {
  ...
  approvedHandler(id){
   ...
   Axios.put(`http://localhost:4000/api/tours/guideapproved/${id}`,{Status:true})
   .then(res =>{
 ...
 unapprovedHandler(id){
  Axios.delete(`http://localhost:4000/api/tours/guideunapproved/${id}`)
  .then(res =>{
   alert("Guide Deleted")
  })
  .catch(err=>{
...
// }
     ...
     componentDidMount() {
        Axios.get("http://localhost:4000/api/tours/guideunapproved")
         .then(res =>{
